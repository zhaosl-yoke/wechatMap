...
function chooseVideo(sourceType = null, sizeType = null, count = null) {
  return new Promise((resolve, reject) => {
    wx.chooseVideo({ sourceType: sourceType, sizeType: sizeType, count: count, success: resolve, fail: reject });
  });
}
